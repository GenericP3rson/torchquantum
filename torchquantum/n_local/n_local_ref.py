...
class NLocal(BlueprintCircuit):
    ...
    def __init__(
        ...
        rotation_blocks: QuantumModule 
        | None = None,
        entanglement_blocks: QuantumModule
        | None = None,
        ...
        initial_state: QuantumDevice | None = None,
        ...
        self._reps = reps
        self._entanglement_blocks: list[QuantumModule] = []
        self._rotation_blocks: list[QuantumModule] = []
        self._prepended_blocks: list[QuantumModule] = []
        self._prepended_entanglement: list[list[list[int]] | str] = []
        self._appended_blocks: list[QuantumModule] = []
...
[docs]    def get_unentangled_qubits(self) -> set[int]:
...
[docs]    def print_settings(self) -> str:
